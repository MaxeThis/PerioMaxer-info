...
(function () {
  ...
  var T = {
    en: {
      ...
      "footer.note": "© <span id=\"year\"></span> SmileMaxer LLC · SmileMaxer is the home of the PerioMaxer app.",
      "footer.note_index": "© <span id=\"year\"></span> SmileMaxer LLC · SmileMaxer is the home of the PerioMaxer app. PerioMaxer is not affiliated with Apple Inc.",
      "footer.note_min": "© <span id=\"year\"></span> SmileMaxer LLC",
    ...
    es: {
      ...
      "footer.note": "© <span id=\"year\"></span> SmileMaxer LLC · SmileMaxer es el hogar de la app PerioMaxer.",
      "footer.note_index": "© <span id=\"year\"></span> SmileMaxer LLC · SmileMaxer es el hogar de la app PerioMaxer. PerioMaxer no está afiliado a Apple Inc.",
      "footer.note_min": "© <span id=\"year\"></span> SmileMaxer LLC",
      ...
      "support.email_btn": "Escribir a support@periomaxer.com",
      "support.email_html": "También puedes copiar la dirección manualmente: <strong>support@periomaxer.com</strong>. Suelo responder en uno o dos días. Al reportar un problema, ayuda incluir tu dispositivo (iPhone, iPad o Mac), la versión de iOS/macOS y una breve descripción de lo que hacías cuando ocurrió el problema.",
    ...
    pt: {
      ...
      "nav.menu_label": "Menu",
      "nav.lang_label": "Idioma",
      "footer.note": "© <span id=\"year\"></span> SmileMaxer LLC · SmileMaxer é o lar do app PerioMaxer.",
      "footer.note_index": "© <span id=\"year\"></span> SmileMaxer LLC · SmileMaxer é o lar do app PerioMaxer. PerioMaxer não é afiliado à Apple Inc.",
      "footer.note_min": "© <span id=\"year\"></span> SmileMaxer LLC",
      ...
      "support.email_btn": "Enviar e-mail para support@periomaxer.com",
      "support.email_html": "Você também pode copiar o endereço manualmente: <strong>support@periomaxer.com</strong>. Costumo responder em um ou dois dias. Ao relatar um problema, ajuda incluir seu dispositivo (iPhone, iPad ou Mac), a versão do iOS/macOS e uma breve descrição do que você estava fazendo quando aconteceu.",
    ...
    ja: {
      ...
      "nav.menu_label": "メニュー",
      "nav.lang_label": "言語",
      "footer.note": "© <span id=\"year\"></span> SmileMaxer LLC · SmileMaxer は PerioMaxer アプリの公式サイトです。",
      "footer.note_index": "© <span id=\"year\"></span> SmileMaxer LLC · SmileMaxer は PerioMaxer アプリの公式サイトです。PerioMaxer は Apple Inc. と提携していません。",
      "footer.note_min": "© <span id=\"year\"></span> SmileMaxer LLC",
      ...
      "support.email_btn": "support@periomaxer.com にメール",
      "support.email_html": "メールアドレスは手動でコピーしてもらっても構いません: <strong>support@periomaxer.com</strong>。通常 1〜2 日以内に返信します。不具合の報告時は、デバイス (iPhone、iPad、Mac)、iOS/macOS のバージョン、発生時の操作の簡単な説明を添えていただけると助かります。",
